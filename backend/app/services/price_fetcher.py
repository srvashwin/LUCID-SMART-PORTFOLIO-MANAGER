...
def fetch_current_price(ticker: str) -> Optional[dict]:
    """Fetch current price and change % from Yahoo Finance free API."""
...
def get_price_for_ticker(ticker: str, db: Optional[Session] = None) -> dict:
    """Get cached price or fetch live. Returns dict with price, change_pct."""
